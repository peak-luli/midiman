...
icons/              the installed app's icons, and make-icons.mjs that draws them and favicon.ico
favicon.ico         the tab icon every page links, drawn by icons/make-icons.mjs
